...
describe('ERC20 contract', function () {
    ...
    const erc20Name = 'AVAT_DEMO_29'
    const erc20Symbol = 'AVT_DEMO_29'
    const totalCap = 100000000000000
    const initialMint = 60000000000000

    // `beforeEach` will run before each test, re-deploying the contract every
    // time. It receives a callback, which can be async.
    beforeEach(async function () {
        // Get the ContractFactory and Signers here.
        Token = await ethers.getContractFactory('Erc20Contract')
